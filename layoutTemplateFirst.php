...
<html>
 <head>
   ...
   <link href='../elec_css/pdfCSS.css' rel='stylesheet'>
...
if (window.XMLHttpRequest)
  ...
  xmlhttp.open("GET","../elec_functionalities/core_functionalities/updateViews.php?a="+fileID,true);
xmlhttp.send();
...
if (window.XMLHttpRequest)
  ...
  xmlhttp.open("GET","../elec_functionalities/core_functionalities/getComments.php?a="+fileID,true);
xmlhttp.send();
    ...
    function storeComments() {
     ...
     // document.getElementById('pdfCommentsText').innerHTML="";
...
if (window.XMLHttpRequest)
  ...
  xmlhttp.open("GET","../elec_functionalities/core_functionalities/storeComments.php?fileID="+fileID+"&userID="+userID+"&comment="+commentDesc,true);
xmlhttp.send();
