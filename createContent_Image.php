...
$groupIMG=$_GET['a'];
$_SESSION['groupIMG']=$groupIMG;
if(!isset($_SESSION['sessionSET']) | $_SESSION['sessionSET']=="false") {
...
<form action="uploadLogicIMG.php" method="post"
                        enctype="multipart/form-data">
<input name='groupIMG' type='hidden' value="<?php echo $groupIMG  ?>" />
<label name='groupName'><?php $groupIMG ?></label>
