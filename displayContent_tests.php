 ...
 ?>
          ...
          <div class='elect_content_display'>
           ...
           <hr style='width:900px;float:left;margin-top:-7px;margin-bottom:-1px;'/>
            <div class="datagrid">
          <table><th colspan="2" style="padding:5px;">Document</th><th>Subject</th>
    <?php
...
$query = "select * from electura_testsmain";
$result = mysql_query($query);
$totalCount = mysql_num_rows($result);

$pagination = new Pagination($page, $per_page, $totalCount);

$pagQuery="select * from electura_testsmain ORDER BY testDate DESC, testTime DESC LIMIT {$per_page} OFFSET {$pagination->offset()} ";
...
//    $udate=$row['uDate'];
  ...
  //  $prof=$row['Professor'];
    ...
    echo "<tr><td><a href=".$flink."></a></td><td style='padding: 15px;'><a id='pad' href=".$flink.">".$fileName."</a><br/>".
    "<small><b>Created By:</b> ".$uploaded."</small></td><td width='100px'>".$topicSubject."</td></tr>";
    ...
    <?php
      if($pagination->total_pages()>1) {
        ...
        if($pagination->has_previous_page()) {
          echo "<li class='previous'><a href=\"displayContent_tests.php?page=";
         ...
         for($i=1;$i<=$pagination->total_pages();$i++) {
          ...
          echo " <li><a href=\"displayContent_tests.php?page={$i}\">{$i}</a> </li>";
        }

        }

        if($pagination->has_next_page()) {
          echo "<li class='next'><a href=\"displayContent_tests.php?page=";
