...
<html>
 <head>
   ...
   <link href='../elec_css/imageCSS.css' rel='stylesheet'>
   <link href='../elec_css/commentsCSS.css' rel='stylesheet'>
...
if (window.XMLHttpRequest)
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("mainIMG").innerHTML=xmlhttp.responseText;
    }
  }

  
  xmlhttp.open("GET","../elec_functionalities/core_functionalities/loadIMG.php?a="+imgID,true);
xmlhttp.send();
  }
    ...
    function initViews() {
      mainImage();
      allImages();
      setInterval(function() {getComments();},3000);
...
if (window.XMLHttpRequest)
  ...
  xmlhttp.open("GET","../elec_functionalities/core_functionalities/updateViewsImage.php?a="+groupID,true);
xmlhttp.send();
    ...
    var groupID=document.getElementById('groupIDLabel').innerHTML;
...
if (window.XMLHttpRequest)
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("commentsDB").innerHTML=xmlhttp.responseText;
    }
  }

  
  xmlhttp.open("GET","../elec_functionalities/core_functionalities/getCommentsImage.php?a="+groupID,true);
xmlhttp.send();
    ...
    function storeComments() {
      ...
      var commentDesc=document.getElementById('pdfCommentsText').value;
...
if (window.XMLHttpRequest)
  ...
  xmlhttp.open("GET","../elec_functionalities/core_functionalities/storeCommentsImage.php?fileID="+groupID+"&userID="+userID+"&comment="+commentDesc,true);
xmlhttp.send();
document.getElementById('pdfCommentsText').value="";
