...
window.onload = function() {
		...
		function init() {
		document.getElementById('testTopic2').innerHTML=testTopic;
		...
		function populateQuestions() {
			...
			if (window.XMLHttpRequest) {
  			...
  			xmlhttp.open("GET","../elec_functionalities/core_functionalities/populateQuestions.php?a="+testID,true);
			xmlhttp.send();
		...
		function deleteQuestion(questionID) {
			...
			if (window.XMLHttpRequest) {
  			...
  			xmlhttp.open("GET","../elec_functionalities/core_functionalities/deleteQuestion.php?a="+qID,true);
			xmlhttp.send();
		...
		function addQuestions() {
			...
			alert("Question must be of at least 5 characters.");
			return false;
		}

			for(var i=0;i<questionsArray.length;i++) {
				if(questionsArray[i]==question) {
				alert('You cannot enter the same question twice.');
				return false;
			}
		}
			...
			if(choiceA=='' | choiceA==' ') {
			alert('Please enter answer choices.');
			...
			alert ('The correct answer must match one of the answer choices.');
			return false;
		}

			questionsArray[z]=question;
			z++;
			...
			if (window.XMLHttpRequest) {
  			...
  			xmlhttp.open("GET","../elec_functionalities/core_functionalities/addQuestion.php?que="+question+"&a="+choiceA+"&b="+choiceB+"&c="+choiceC+"&d="+choiceD+"&ca="+correctAnswer+"&testTop="+testTopic+"&comp="+questionStatus+"&cr="+credits+"&testID="+testID,true);
			xmlhttp.send();
		}
	</script>
	<style> 
