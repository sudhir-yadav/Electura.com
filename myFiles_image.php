...
$query = "select * from electura_files_image";
...
if(!$pagResult) {
  ...
  $query2="select * from electura_files_image";
    ...
    <?php
      if($pagination->total_pages()>1) {
        ...
        if($pagination->has_previous_page()) {
          echo "<li class='previous'><a href=\"myFiles_image.php?page=";
         ...
         for($i=1;$i<=$pagination->total_pages();$i++) {
          ...
          echo " <li><a href=\"myFiles_image.php?page={$i}\">{$i}</a> </li>";
        }

        }

        if($pagination->has_next_page()) {
          echo "<li class='next'><a href=\"myFiles_image.php?page=";
